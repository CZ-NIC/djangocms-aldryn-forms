...
from aldryn_forms.utils import get_form_anchor, get_plugin_tree, get_post_form
...
def get_response(
    ...
    if data["status"] == "SUCCESS":
        ...
        if form_plugin.message_on_form:
            anchor = get_form_anchor(form_plugin.pk)
            success_url += "#" + anchor
            request.session[anchor] = True
        if success_url:
